...
<body>
	...
	<div id="detail">
	 <div>
	 <p><span class="d-title">打刻内容</span></p>
        ...
        <table>
        	...
        	<tr>
        		<td><input type="hidden" name="pzlb" value="${pzlb }"/>
        	</tr>
        	
        </table>
        <p id="saveid"><div class="buttons"><input class="r" type="button" value="保存" onclick="sub('mark')"/></div></p>
        <c:if test="${flag == true }">
