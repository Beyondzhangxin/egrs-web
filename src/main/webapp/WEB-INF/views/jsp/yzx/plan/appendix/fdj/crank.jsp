...
<body>
	...
	<div id="detail">
	 <div>
	 <p><span class="d-title">曲轴箱</span></p>
        ...
        <table>
        	...
        	<tr>
        		<td><input type="hidden" name="pzlb" value="QZX"/>
        	</tr>
       ...
       <form:form modelAttribute="bs" action="" class="formid" > 
        ...
        <p id="saveid"><div class="buttons"><input class="r" type="button" value="保存" onclick="sub('config','0')"/></div></p>
        <c:if test="${flag == true }">
