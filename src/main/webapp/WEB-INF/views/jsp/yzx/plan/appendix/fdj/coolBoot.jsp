...
<body>
	...
	<div id="detail">
	 <div>
	 <p><span class="d-title">冷启动</span></p>
	 	 <form:form modelAttribute="car" action="" id="formid" > 
        <table>
        	<tr>
        		<td>冷启动原理</td>
        		<td>
        			<form:input path="lqdgzyl" disabled="${flag }"/>
        		</td>
        	</tr>
        	
        </table>
        <p id="saveid"><div class="buttons"><input class="r" type="button" value="保存" onclick="sub('coolBoot')"/></div></p>
        <c:if test="${flag == true }">
