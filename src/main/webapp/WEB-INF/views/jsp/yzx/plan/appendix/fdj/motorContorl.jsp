...
<body>
	...
	<div id="detail">
	 <div>
	 <p><span class="d-title">电机控制</span></p>
        ...
        <table>
        	...
        	<tr>
        		<td><input type="hidden" name="pzlb" value="DJKZQ"/>
        	</tr>
       ...
       <form:form modelAttribute="bs" action="" class="formid" > 
        ...
        <p id="saveid"><div class="buttons"><input class="r" type="button" value="保存" onclick="sub('config','7')"/></div></p>
        <c:if test="${flag == true }">
