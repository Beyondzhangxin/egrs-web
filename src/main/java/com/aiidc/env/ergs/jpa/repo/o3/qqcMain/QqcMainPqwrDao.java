 ...
 */
@Repository
public interface QqcMainPqwrDao extends PagingAndSortingRepository< QqcMainPqwr, Serializable>, JpaSpecificationExecutor< QqcMainPqwr> {
	
	 QqcMainPqwr findByJybgbh(String jybgbh);
