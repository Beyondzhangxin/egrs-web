 ...
 *
 */
public interface QqcFdjDao extends CrudRepository<QqcFdj, String> {
	//根据附录编号查询素有的发动机；
	public List<QqcFdj> findByFlbh(String flbh);
	//根据附录编号和发动机编号删除发动机；
	@Transactional
	@Modifying
	@Query("delete from QqcFdj where flbh = ?1 and fdjbh = ?2")
	public void deleteByFlbhAndFdjbh(String flbh,Integer fdjbh);
	//根据附录编号和发动机编号查出发动机；
	public QqcFdj findByFlbhAndFdjbh(String flbh,Integer fdjbh);
	//根据计划书编号删除
	@Modifying
	@Transactional
