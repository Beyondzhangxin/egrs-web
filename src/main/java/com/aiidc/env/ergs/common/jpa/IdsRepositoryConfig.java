...
@EnableJpaRepositories(entityManagerFactoryRef = IdsRepositoryConfig.DS_NAME
		+ "EntityManagerFactory", transactionManagerRef = IdsRepositoryConfig.DS_NAME
				+ "TransactionManager", basePackages = { "com.aiidc.env.ergs.jpa.repo." + IdsRepositoryConfig.DS_NAME })
public class IdsRepositoryConfig {

	protected static final String DS_NAME = "ids";
