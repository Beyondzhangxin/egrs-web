...
@EnableJpaRepositories(entityManagerFactoryRef = O3RepositoryConfig.DS_NAME
		+ "EntityManagerFactory", transactionManagerRef = O3RepositoryConfig.DS_NAME
				+ "TransactionManager", basePackages = { "com.aiidc.env.ergs.jpa.repo." + O3RepositoryConfig.DS_NAME })
public class O3RepositoryConfig {

	protected static final String DS_NAME = "o3";
