...
@EnableJpaRepositories(entityManagerFactoryRef = PwRepositoryConfig.DS_NAME
		+ "EntityManagerFactory", transactionManagerRef = PwRepositoryConfig.DS_NAME
				+ "TransactionManager", basePackages = { "com.aiidc.env.ergs.jpa.repo." + PwRepositoryConfig.DS_NAME })
public class PwRepositoryConfig {

	protected static final String DS_NAME = "pw";
